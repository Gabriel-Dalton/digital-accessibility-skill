...
Complete checklist organized by principle and guideline. Each item references its success criterion number.
...
- **1.1.1 Non-text Content (A)** — All non-text content has a text alternative that serves the equivalent purpose.
  ...
  - Decorative images: `alt=""` plus `role="presentation"` or implement via CSS
...
- **1.4.3 Contrast (Minimum) (AA)** — Text has at least 4.5:1 contrast ratio. Large text (≥18pt bold or ≥24pt) has at least 3:1.
